...
async def index_evm_events_task(
    *,
    ...
    try:
        ...
        indexer: AnalyticsEvmEventsIndexer = evm_events_indexer_factory(
            backend=backend,
            engine=engine,
        )
